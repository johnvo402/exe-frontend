        ...
        >
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            ...
            >
              ...
              >
                Capture your favorite moments and carry them with your own,{" "}
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          >
            ...
            >
              ...
              pointer-events-none absolute inset-x-0 -bottom-6 text-green-600"
                />
              </span>{" "}
              say
            </h2>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Had the case for a few months now and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the image is super clear
                  </span>
                  , on the case I had before, the image started fading into
                  yellow-ish color affter a couple weeks. Love it"
                </p>
              </div>
