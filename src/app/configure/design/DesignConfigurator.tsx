...
interface DesignConfiguratorProps {
  configId: string;
  imageUrl: string;
  imgaeDimensions: { width: number; height: number };
}
    ...
    <div className="relative mt-20 grid grid-cols-3 mb-20 pb-20">
      ...
      >
        ...
        >
          ...
          right-[3px] bottom-px rounded-[32px] shadow-[0_0_0_99999px_rgba(229,231,235,0.6)]"
          />
          <div
            className={cn(
        ...
        <Rnd
          default={{
            x: 150,
            y: 205,
            height: imgaeDimensions.height / 4,
            width: imgaeDimensions.width / 4,
          }}
          lockAspectRatio
      ...
      <div className="h-[37.5em] flex flex-col bg-white">
        <ScrollArea
                    ...
                    {Colors.map((color) => (
                      <RadioGroup.Option
                        ...
                        className={({ active, checked }) =>
                          cn(
                            "relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 active:ring-0 focus:ring-2 active:outline-none focus:outline-none border-2 border-transparent",
                            {
